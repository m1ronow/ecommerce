...
function packObject(input, options) {
  ...
  const resolveKey = (index) => {
    const arr = asArray2(options == null ? void 0 : options[index]);
    return arr.find((k2) => {
...
function packMeta(inputs) {
  ...
  return packArray(inputs, {
    ...
    resolveKey(k) {
      var _a, _b;
      let key = ((_b = (_a = mappedPackingSchema.filter((sk) => sk[1] === k)) == null ? void 0 : _a[0]) == null ? void 0 : _b[0]) || k;
      const replacer = (_, letter) => letter == null ? void 0 : letter.toUpperCase();
